<template>
  <div class="t-container">
    <Container>
        ...
        <li v-for="event in events" :key="event.sys.id">
          <div class="c-tile">
            <div class="c-tile__container">
              <pretty-date :date="event.fields.start" class="dt-start" />
              <h3 class="o-headline-3 u-marginBottomTiny p-name">
                {{ event.fields.name }}
              </h3>
      ...
      <nuxt-link slot="footerLine" to="/i-would-love-to-speak/" class="o-btn u-marginTopLarge">
    ...
    <Container>
      ...
      <ul class="o-list-grid">
        <li v-for="talk in talks" :key="talk.sys.id" class="u-marginBottomLarge">
          <Talk :talk="talk" />
        </li>
      </ul>
    </Container>
